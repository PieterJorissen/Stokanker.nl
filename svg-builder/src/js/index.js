...
document.getElementById('underlay-export-toggle').addEventListener('change', handleUnderlayExportToggle);
document.getElementById('underlay-clear').addEventListener('click', () => {
    Object.assign(drawing.underlay, structuredClone(defaults.underlay));
    document.getElementById('underlay-upload').value = '';
    document.getElementById('underlay-opacity').value = defaults.underlay.opacity;
    document.getElementById('underlay-export-toggle').checked = false;
    commitDrawingToStorage();
